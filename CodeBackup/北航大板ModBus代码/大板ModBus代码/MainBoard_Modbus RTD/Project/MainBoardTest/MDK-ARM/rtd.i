...
void RTD_init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = (((uint16_t)0x8000)) | (((uint16_t)0x2000)) ;
    ...
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000)),((uint16_t)0x2000));
    delay_rtd();
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0080));
...
uint8_t rtd_read_write_byte(uint8_t c)
{
    ...
    for (i = 0; i < 8; ++i) {
        res <<= 1;
        GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000)),((uint16_t)0x2000));
        if(c&0x80){
            GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000)),((uint16_t)0x8000));
        }
        else{
            GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000)),((uint16_t)0x8000));
        }
        
        delay_rtd();
        GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000)),((uint16_t)0x2000));
        delay_rtd();
        if(((GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2000)),((uint16_t)0x4000))==Bit_SET)?1:0)){
            res |= 1;
        }
        c <<= 1;
    }
