...
{					     
	...
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0040)|((uint16_t)0x0080)); 	
}

void IIC_Start(void)
{
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL&=0X0FFFFFFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL|=3<<28;};     
...
{
	u8 ucErrTime=0;
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL&=0X0FFFFFFF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL|=8<<28;};      
