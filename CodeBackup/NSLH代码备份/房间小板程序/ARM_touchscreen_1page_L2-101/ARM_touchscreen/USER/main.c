...
//	Mtemp  = (tdata[2]*256+tdata[3])-28;
	...
	if(Temp1>25.0&&Temp1<27.1)
		Temp1=0.2266*Temp1*Temp1-11.165*Temp1+162.35;
	else if(Temp1>=27.1)
		Temp1=0.52*Temp1+12.4;
	
	Mtemp=rint(Temp1*10.0);
	
	if(Mtemp<180)Mtemp=180;
	if(Mtemp>290)Mtemp=290;
