...
extern char WkSLevelAlarm   ;
extern char WkSLevelHigh    ;

extern char RsLevelMaxAlarm ;
extern char RsLevelStart	 ;	
extern char RsLevelStop	 ;
extern char RsLevelMinAlarm ;

extern float DeltaCon;
extern float DeltaConPC;


extern char SSLevelAlarm   ;
extern char SSLevelHigh    ;

//extern float  AIrangIn[12];
//extern float  Setpoint[3];
//extern float  SetpointPC[3];

extern float  reAOReset(int port,float par1,float par2,float par3);    
extern float  reDOReset(int port,float par1,float par2,float par3)   ;

extern char regStart(PARAMS *arin,PARAMS *arout,char *dout);
extern char regStop(PARAMS *arin,PARAMS *arout,char *dout);
extern char RE_Level_Alarm(void);  
