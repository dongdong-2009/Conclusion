...
namespace Designer.StaticFunctions
{
    /// <summary>
    /// 数据库的通用访问代码 
    /// 
    ...
    public abstract class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static readonly string connectionString = System.Configuration.ConfigurationManager.OpenMappedExeConfiguration(new ExeConfigurationFileMap() { ExeConfigFilename = StaticFunctions.DAStaticFunctions.CONFIGURATION_FILE_NAME }, ConfigurationUserLevel.None).AppSettings.Settings[StaticFunctions.DAStaticFunctions.DATABASECON].Value;

        //public static readonly string connectionString = System.Configuration.ConfigurationManager.AppSettings[StaticFunctions.DAStaticFunctions.DATABASECON].ToString().Trim();
