...
//            string currentName = "Deccw_"+t.Name.ToString();
...
//            m_PortBind.SetValue(tb, PortBind, null);
        ...
        private void Startblock_Click(object sender, EventArgs e)
        {
          ...
          //              currentcomp.BoardNumber = BoardNumber;
          //              currentcomp.RelatedPort = RelatedPort;
          //              currentcomp.Value = (int)(float.Parse(rtdm.GetDataByBoardPort(BoardNumber, RelatedPort)));
          //              currentcomp.rtdm = rtdm;
          //              if (currentcomp.rtdm == null)
          //                  return;
          //          }
          ...
          //              currentcomp.sendData.Text = rtdm.GetDataByBoardPort(BoardNumber, RelatedPort);
          //              currentcomp.rtdm = rtdm;
          //              if (currentcomp.rtdm == null)
          //                  return;
          //          }
