...
namespace Library
{
    ...
    public partial class Scale : UserControl
    {
        ...
        private void DrawHorizontal(Graphics g)
        {
            ...
            Pen p = new Pen(NeedleColor);
            // Draw scale needle
            g.DrawLine(p, Wm - 0, 0, Wm - 0, H);
            g.DrawLine(p, Wm - 1, 0, Wm - 1, H);
            p.Dispose();
        }
        ...
        private void DrawVertical(Graphics g)
        {
            ...
            Pen p = new Pen(NeedleColor);
            // Draw scale needle
            g.DrawLine(p, 0, Hm + 0, W, Hm + 0);
            g.DrawLine(p, 0, Hm + 1, W, Hm + 1);
            p.Dispose();
        }
