...
namespace Designer.StaticFunctions
{
    class DAStaticFunctions
    {
        ...
        public static SqlConnection getConn(string connString)
        {
            ...
            conn.ConnectionString = System.Configuration.ConfigurationManager.OpenMappedExeConfiguration(new ExeConfigurationFileMap() { ExeConfigFilename = CONFIGURATION_FILE_NAME }, ConfigurationUserLevel.None).AppSettings.Settings[StaticFunctions.DAStaticFunctions.DATABASECON].Value;
