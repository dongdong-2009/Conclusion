...
float chanvalue12(float volt)
{
    ...
    value=value/0.7501/POWER_PT;
    value=(value-1)*2999.3;
    return value;        
}
float chanvalue13(float volt)
{
    ...
    value=volt/33.286;
    value=value+POWER_PT;
    value=value/0.75044/POWER_PT;
    value=(value-1)*3001.7;
    return value;        
}
float chanvalue14(float volt)
{
    ...
    value=volt/35.11;
    value=value+POWER_PT;
    value=value/0.7488867/POWER_PT;
    value=(value-1)*3002.1545;
    return value;        
}
float chanvalue15(float volt)
{
    ...
    value=volt/33.5445;
    value=value+POWER_PT;
    value=value/0.7502/POWER_PT;
    value=(value-1)*3005.2865;
    return value;        
} 
