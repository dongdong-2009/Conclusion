...
{
	WriteBuf[0]=(u8)(RoomTempSv&0xff);
	WriteBuf[1]=(u8)(TempSPSet_Unocc&0xff);
	WriteBuf[2]=(u8)(ERVCmd&0xff);
	WriteBuf[3]=(u8)(IBSCommand&0xff);
	WriteBuf[4]=(u8)(ScheduleComm&0xff);
	WriteBuf[5]=(u8)(PurgeCmd&0xff);
	WriteBuf[6]=(u8)(ValveCmd&0xff);
	WriteBuf[7]=(u8)(PDVComm&0xff);
	WriteBuf[8]=RunStatus;
	WriteBuf[9]=(u8)(OccSta&0xff);
	WriteBuf[10]=0xAA;
}
