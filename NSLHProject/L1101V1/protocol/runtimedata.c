...
void DataProcess(void)
{
	switch(TaskSel)
  {
	  ...
	  case READPORTS:    readPorts(ReadPortsBuffer);Get_value(ADC_value[OffCoilTemp],RTD_value[CHWInTemp],RTD_value[CHWOutTemp],DI_data[OccuState],DI_data[BMSSignal]);break;		 
