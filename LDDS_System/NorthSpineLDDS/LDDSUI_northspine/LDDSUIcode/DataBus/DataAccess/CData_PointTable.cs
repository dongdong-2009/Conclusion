...
namespace DataBus.DataAccess
{
    public class CData_PointTable
    {
        ...
        public void GetBoardPortByNameBdnum(string Name, string Number, ref string RelatedPort, ref string DeviceType,ref string code)
        {
            ...
            try
            {
                ...
                code = matches[0]["Number"].ToString();
                RelatedPort = matches[0]["Port"].ToString();
            }
            catch
            {
        ...
        public void GetBoardSendPortByNameBdnum(string Name, string Number, ref string RelatedPort, ref string PortData, ref string PortBind,ref string Code)
        {
            DataTable PointTable = GetPointTable();
