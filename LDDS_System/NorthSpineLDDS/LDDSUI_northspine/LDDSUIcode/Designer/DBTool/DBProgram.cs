...
namespace Designer.DBTool
{
    public class DBProgram
    {
        ...
        private int sampleTableLength=40;
       //DataBus
        ...
        private void addNewContent(string myboard)
        {
            ...
            if (cnt == 0)
            {
                sql = "INSERT INTO ide_point" +
                        "(Number,Port,Description,Name,Bindport,Status,Senddataport,Type)" +
                        "SELECT Number,Port,Description,Name,Bindport,Status,Senddataport,Type FROM " +
                         myboard + "_nssample";
