...
{
    public partial class Dehumidifier1 : Module
    {

        public Dehumidifier1 parentDehumidfier1;
       ...
       // public event BtnclickHandle UserControlBtnClicked;
        ...
        private void sendButtonClick(object sender, EventArgs e)
        {
            ...
            string currentName = "Deccw_"+ tb.Name.ToString();

            dataPT.GetBoardPortByNameBdnum(currentName, BoardNumber, ref RelatedPort, ref DeviceType, ref Boardcode);
            dataPT.GetBoardSendPortByNameBdnum(currentName, BoardNumber, ref RelatedPort, ref PortData, ref PortBind,ref Boardcode );
            bool isSuccess = dataSend.SendControlData(tb.sendData.Text, RelatedPort, PortBind, Boardcode);
