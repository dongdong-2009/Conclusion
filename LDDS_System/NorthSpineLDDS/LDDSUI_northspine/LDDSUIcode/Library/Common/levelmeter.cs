...
namespace Library.Common
{
    public partial class levelmeter : VerticalProgressBar
    {
        ...
        private void Timer_Tick(object sender, EventArgs e)
       {
            ...
            string Boardcode = "";
            float midvalue = 0;
           dataPT.GetBoardPortByNameBdnum(stringName, BoardNumber, ref RelatedPort,ref type ,ref Boardcode);
            if (rtdm != null)
                midvalue = float.Parse(rtdm.GetDataByBoardPort(Boardcode, stringName, RelatedPort));
