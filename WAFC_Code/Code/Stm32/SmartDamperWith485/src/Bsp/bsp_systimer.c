...
{
	int temp;
	temp = _diff_uint32(T1.nX10ms, T2.nX10ms)*10000;
	if (temp>0) // T1 later than T2
	{
		temp += ((int)T2.nSysTick - (int)T1.nSysTick)/72;
	}
	else if (temp<0) //T1 earlier than T2
	{

	}
	else //T1 and T2 in same globalTime
	{
