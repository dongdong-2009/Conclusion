...
///<Return value>:  Null
///////////////////////////////////////////////////////////////////////////////////////
void PacketHeaderGeneration(u8* sentData)
{
   sentData[0] = 0x55;
   sentData[1] = 0x66;
   ...
   SentCheckCode=CheckSentData(sentData);

   sentData[21] = SentCheckCode;		  //CheckCode
   sentData[22] = 0x66;                   //Length
   sentData[23] = 0x55; 
}
...
int CheckReceivedData(u8* dataBuffer)
{
   ...
   long result = 0;
   int checkCode = 0;
    if((dataBuffer[5]==2)&&(dataBuffer[6]==2)&&(dataBuffer[6]==2))
	return 0;
	if(dataBuffer[2]!=7)
	return 0;
   for(i=3;i<21;i++)
