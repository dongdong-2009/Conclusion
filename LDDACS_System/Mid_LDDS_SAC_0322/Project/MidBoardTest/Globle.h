...
extern  float  bufRegisters[16];
extern  float  boardRegisters[3];
...
extern void DEsendBufferFill (u8 *readPortsBuffer);
extern void REsendBufferFill (u8 *readPortsBuffer);
extern void DE1receBufferFill(u8 *ReceivedBuffer);
extern void	REreceBufferFill(u8 *ReceivedBuffer);
...
extern void PacketHeaderGeneration(u8* sentData,u8 selectedBoard);
...
extern void statusCheck(void);
extern void lowbufCheck(void);
