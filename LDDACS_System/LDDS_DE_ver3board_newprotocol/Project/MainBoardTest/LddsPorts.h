...
//AI
#define   CPUMPFB            0   //circulation pump feedback
#define   SFANFB             1   //supply fan feedback
#define   CCWVALVEFB		 2   //chilled water feedback for cooling coil
#define   CWVALVEFB		 	 3   //chilled water feedback for desiccant solution

#define   TIN   			 4   //inlet temperature after coil
#define   RHIN  		     5   //inlet RH after coil
#define   TOUT   			 6   //outlet temperature
#define   RHOUT  		     7   //outlet RH
#define   BUFLEVEL           8   //strong solution buffer level
#define   DATASET           10   //RH set value

//RTD
#define   TCCWIN		       0  //除湿Outlet温度
#define   TCCWOUT		       1  //除湿Outlet温度
#define   TWIN		           2  //除湿Inlet温度
#define   TSIN		           3  //CHILL WATER Inlet温度



//AO

#define   CCWVALVE 			   0  //chilled water valve for cooling coil
#define   CWVALVE			   1  //chilled water valve 
#define   SFAN 			       2  //VSD supply fan
#define   CPUMP		    		3  //VSD circulation pump
#define   RHDATA 			   6  //current RH

//DO

#define	  STVALVE			   0  //solution tank valve
#define   ALARM			       1

#define   TRPUMP			   7  //without SLC

//DI
#define   LOCALORREMOTE      0  //本地开关
#define   STARTDE            1
#define   FAUT_FANVSD        2  //pump vsd fault
#define   FAUT_PUMPVSD       3  //fan vsd fault
#define   FAUT_TFPUMP        4  //transfer pump OL fault
