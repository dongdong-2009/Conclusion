...
//uint16_t PWMREG[4]={0};
//uint16_t DAmodREG[8] ={0};
//uint16_t ADmodREG[12] ={0};
//
//uint16_t PCWriteREG[24]={0};
//uint16_t PCReadREG[24]={0};
//uint16_t UserUsartinUse = 0;
//
//uint8_t TimerOverFlag=0;
//uint8_t BegainRxFlag=0;
//uint8_t BusyFlag=0;
//
//uint8_t TimerOverFlagUser=0;
//uint8_t BegainRxFlagUser=0;
//uint8_t BusyFlagUser=0;
