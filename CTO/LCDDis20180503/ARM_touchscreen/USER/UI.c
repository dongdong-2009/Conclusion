...
unsigned char PAGE1(int PvRH,int PvTe,int TempData)
{
	char ss[6];	
	unsigned char i=0;			    
  ...
  showzifustr(262,60,"RH:",0x0000,BLUEBG,1);
	showzifustr(262,158,"CoilTemp:",0x0000,BLUEBG,1);
	...
	showzifustr(370,188,"$C",0,BLUEBG,1);
...
unsigned char PAGE2(int SvTe,int SvCO2)
{
	...
	showzifustr(20,60,"Fan Speed %",0x0000,BLUEBG,1);
    showzifustr(272,60,"  Valve Pos %",0x0000,BLUEBG,1);
