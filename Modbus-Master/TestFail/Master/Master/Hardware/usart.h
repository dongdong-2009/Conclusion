...
#define RS_485_TX_EN() 	do{ GPIO_ResetBits(GPIOB , GPIO_Pin_14); GPIO_ResetBits(GPIOD, GPIO_Pin_7);}while(0)	//接收使能
#define RS_485_RX_EN() 	do{ GPIO_SetBits(GPIOB , GPIO_Pin_14); GPIO_SetBits(GPIOD, GPIO_Pin_7);}while(0)	//发送使能
